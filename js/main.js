...
document.addEventListener("DOMContentLoaded", function () {
	...
	var qrCode2Image = new Image();
	qrCode2Image.src = new QRCode(document.createElement("div"), {
		text: "https://u.wechat.com/EMw5cw9h1vShFauLLkif3vY",
		width: 300,
		height: 300,
		correctLevel: QRCode.CorrectLevel.H,
	})._el.firstChild.toDataURL();
	var qrCode2Element = document.getElementById("qr-code2");
	qrCode2Element.appendChild(qrCode2Image);

	var qrCode3Image = new Image();
	qrCode3Image.src = new QRCode(document.createElement("div"), {
		text: "https://qm.qq.com/q/c2yIcuV8AM",
		width: 300,
		height: 300,
		correctLevel: QRCode.CorrectLevel.H,
	})._el.firstChild.toDataURL();
